...
├── 03-Machine-Learning/        33 casos: supervisado, no supervisado, RRNN, series
...
**33 casos prácticos** de ML organizados por tipo de aprendizaje y familia de modelo: regresión, clasificación, clustering, PCA, t-SNE, redes neuronales (MLP, CNN, SOM) y series temporales (ARIMA).

**Stack:** scikit-learn, TensorFlow/Keras, XGBoost, minisom, statsmodels, pmdarima.

**[Ver los 33 proyectos →](03-Machine-Learning/)**
